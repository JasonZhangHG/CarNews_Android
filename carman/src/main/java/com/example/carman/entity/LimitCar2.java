...
public class LimitCar2 {
    /**
     * reason : 查询成功
     * result : {"date":"2017-05-12","week":"星期五","city":"beijing","cityname":"北京","des":[{"time":"私家车：限行时间段为周一至五的早7时至晚20时(法定节假日和公休日不限行)","place":"限行范围为五环路以内（不包括五环路主路）","info":""},{"time":"公务车：停驶时间为0时至24时","place":"停驶范围为本市行政区域内所有道路","info":""}],"fine":"京牌罚100块，不扣分。非京牌罚100块，扣3分。","remarks":"临时号牌按号牌尾号数字限行。机动车车尾号为英文字母的按0号管理","isxianxing":1,"xxweihao":[2,7],"holiday":""}
     * error_code : 0
     */
