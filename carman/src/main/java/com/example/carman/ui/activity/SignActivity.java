...
public class SignActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptSign(){
        ...
        final String userPwd = mPasswordView.getText().toString();
        ...
        RetrofitUtils.reigister getNet = RetrofitUtils.getInstenct().create(RetrofitUtils.reigister.class);
        getNet.register(userName,userPwd)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<RegisterBean>() {
                    @Override
                    public void onCompleted() {
//                        Toast.makeText(SignActivity.this,"请求成功啦",Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onNext(RegisterBean loginBean) {
                        ...
                        mAuthTask = new UserLoginTask(userName, userPwd);
...
//        }else  if (result==-1)
//        {
//            Toast.makeText(SignActivity.this,"用户名已经存在！",Toast.LENGTH_SHORT).show();
//        }
//        else
//        {
